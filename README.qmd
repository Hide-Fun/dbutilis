...
acc_classification <- db_classify_acc(.acc = acc_raw)
acc_used <- acc_classification |>
  filter(
    query != 0,
    !str_detect(sequence_type, "STS|cDNA|Genome|WGS|SRA|protein|scaffold|EST|TPA|TSA|TLS|HTC|HTG|GSS|MGA")
  )
